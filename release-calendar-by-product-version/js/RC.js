...
function drawReleaseClendarForGAVersions() {
    var data = [];
...
function drawReleaseCalendarForSelectedProducts(product_name) {

    $.post("/portal/controllers/apis/release-calendar/release-data-per-product.jag", {'product_name': product_name}, function (datax) {

        var data = JSON.parse(datax);
        if (product_name == "") {
            showLog("No Redmine Project Record");
        }
        else if (data == null) {
            showLog("No data");
